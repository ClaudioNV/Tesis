...
//$(document).ready(function () {
    ...
    /*$.getJSON(repos, { op: 'getmarker', })
        .done(function (data) {
            //dato = data.da                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   to;
            lugares = {
                direccion1 = data.latitud,
                direccion2 = data.longitud
            }
            for (i = 0; i< lugares; i++){
                marcadores = new google.maps.Marker( {
                    
                    //position: new google.maps.latlng(lugares[i][1]),
                   // map: map,
                });
            }    
...
$('#submit').click(function (e) {
    ...
    if (bandera == true) {
        ...
        $.getJSON(repos, { op: 'Registrarclase', nombreclas: nombreclase, direcname: address, horain: fecha, Latitude1: direccion1, Longitude1: direccion2 });
    ...
    $.getJSON(repos, { op: 'getmarker', })
        .done(function (data) {
        	...
        	for (var i = 0; i < data.length; i++) {
	            ...
	            var tip = 'https://tencuentrogps.com/intra/uploads/img/moto-ocupado.png';// marcador imagen
	            var imgtipo = 'https://tencuentrogps.com/intra/uploads/moto-ocupado.png';// imagen de ventana
