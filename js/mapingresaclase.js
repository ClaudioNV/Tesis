...
$('#registrarClase').click(function(e) {
    ...
    var hours = fecha.substr(11, 1);
    var minutes = fecha.substr(13, 2);
    var seconds = fecha.substr(15, 2);

    //07 / 05 / 2018 6: 00 PM


    fechabd_inicio = year + "/" + month + "/" + day + " " + hours + ":" + minutes + ":" + seconds 

    console.log(fechabd_inicio);
    ...
    /*var day = fecha2.substr(0, 2);
    var month = fecha2.substr(3, 2);
    var year = fecha2.substr(6, 4);
    var hours = fecha2.substr(11, 1);
    var minutes = fecha2.substr(13, 2);
    var seconds = fecha2.substr(15, 2);

    //07 / 05 / 2018 6: 00 PM


    fechabd_fin = year + "/" + month + "/" + day + " " + hours + ":" + minutes + ":" + seconds*/
