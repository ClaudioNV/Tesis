        	...
        	for (var i = 0; i < data.length; i++) {
                ...
                var idclasezumba = usuario.id;
	              ...
	              if (usuario.latitud!="") { // valido que el campo de la latitud no este vacio
                      ...
                      var value = "<center style='width:180px;'><img style ='width: 6em;' src ='" + imgtipo + "'><br><span style='font-size:1.5em;color:#da8160;'><b>" + usuario.instructor+ "</b></span><br><br> <button onclick=(funtiondatos("+idclasezumba+"))>abrir modal</button> </center>";
