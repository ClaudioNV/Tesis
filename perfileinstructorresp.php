...
<html>
  ...
  <section>
    ...
    <div class="container" style="margin-top: 10px;">
      <div class="profile-head">
        ...
        <div class="col-md-5 col-sm-5 col-xs-12">
          ...
          <ul>
            <li><span class="glyphicon glyphicon-briefcase"></span> Instructor</li>
             <li><span class="glyphicon glyphicon-envelope"></span><a href="" title="mail">cgonzalez2302@gmail.com</a></li>
    ...
    <div id="sticky" class="container">
      ...
      <!-- Nav tabs -->
      <ul class="nav nav-tabs nav-menu nav-responsive" role="tablist">
        <!--<li class="active">
