...
<div class="navbar navbar-default navbar-fixed-top">
        <div class="container">                 
              ...
              <a href="/home.php"> <img class="logo img-responsive" src="img/logotipo.png"/></a>
              </div>
                            ...
                            <form>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" placeholder="Nombre" class="form-control1" required>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="phone" type="text" placeholder="Telefono celular" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
