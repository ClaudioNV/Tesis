...
switch ($_GET["op"]) {
	...
	case 'getinstructor':
		...
		$sql=mysql_query("SELECT nombre ,apellido, correo, telefono, direccion, password ,password2, sexo, foto FROM usuario WHERE id = '".$id_usuario."'");
		//$i=0;
	...
	case 'actualiza':
		...
		password='".$pw."',password2 = '".$pw2."',sexo = '".$sexo."', foto = '".$foto."' WHERE id = '".$id_usuario."'");
