  ...
  echo '<script> alert("Faltan campos que completar!!"); </script>';
    ...
    $sql = mysql_query("SELECT * FROM usuario  WHERE = '".$user."'");
        if ($row=mysql_fetch_array($sql)){
            ...
            mysql_query("INSERT INTO usuario (rut_usuario,username, password, password2, nombre, apellido, correo, direccion, telefono, id_tipo_usuario, foto)VALUES ('".$run."','".$user."','".$pw."','".$pw2."','".$name."','".$lastname."','".$e_mail."','".$address."','".$phone."','".$tipo_usuario."')");
