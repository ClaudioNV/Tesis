  ...
  <section>
    ...
    <div id="sticky" class="container">
      ...
      <ul class="nav nav-tabs nav-menu" role="tablist">
        ...
        <li><a href="http://korpovibro.cl/Ingresarnuevaclase.php" role="tab" data-toggle="tab">
      ...
      <div class="tab-content">        
        <div class="tab-pane fade active in" id="change">
          <div class="container fom-main">
            <div class="row">
              <div class="col-sm-12">
                <h2 class="register">Actualice su perfil para mayor seguridad</h2>
              </div><!--col-sm-12 close-->
                ...
                <div class="form-group col-md-12">
                                        ...
                                        <div class="col-md-7">
                                          <select name="select">
                                            ...
                                            <option value="masculino">No informar</option>
                                          </select>
