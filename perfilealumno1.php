      ...
      <div class="profile-head">
        ...
        <div class="col-md-5 col-sm-5 col-xs-12">
          ...
          <ul>
            ...
            <li><span class="glyphicon glyphicon-envelope"></span><a href="#" title="mail"></a>nnn</li>
            ...
            <div class="row">
              ...
              <form class="form-horizontal main_form text-left" action=" " method="post"  id="contact_form">
                ...
                <div class="form-group col-md-12">
                  ...
                  <div class="col-md-12 inputGroupContainer">
                    <div class="input-group">
                      <textarea id="direccion" class="form-control" name="direccion" placeholder="Pasaje/Calle, Número, Comuna"></textarea>
                    </div>
                  </div>
                </div>
