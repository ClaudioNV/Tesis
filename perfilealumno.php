...
<html>
  ...
  <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">                 
              ...
              <a href="/homealumno.php"> <img class="logo img-responsive" src="img/logotipo.png"/></a>
              </div>
  ...
  <section>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="text-center">
            <div class="col-md-5 col-sm-5 col-xs-12">
              <img src="#" class="avatar img-circle img-thumbnail" alt="foto" id="foto">
              </br>
    ...
    <div id="sticky" class="container" style="margin-top: 30px;">
        ...
        <ul class="nav nav-tabs nav-menu " role="tablist">
          ...
          <li><a href="/perfilealumno.php">
            Perfil
            </a>
          </li>
          <li><a href="/Misclasesalumno.php" >
            Mis Clases
            </a>
          </li>
